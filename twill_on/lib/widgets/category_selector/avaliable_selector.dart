...
class AvaliableSelector extends StatefulWidget {
  @override
  _AvaliableSelectorState createState() => _AvaliableSelectorState();
}

class _AvaliableSelectorState extends State<AvaliableSelector> {
  int selectedIndex = 1; //need go pass this in from screen
